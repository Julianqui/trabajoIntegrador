...
@section('content')
	...
	<img src="{{ Storage::url('products/' . $product->image) }}" style="width:300px;">

	<form action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data" style="margin-left:10%;">
		@csrf
		{{ method_field('PUT') }}
		<div class="row">
			<div class="col-6">
