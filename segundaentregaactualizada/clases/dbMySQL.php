...
class DBMySQL extends DB {
	...
	public function __construct() {
		$dsn = 'mysql:host=localhost;dbname=ahora3;
	...
	function traerTodos() {
		...
		foreach ($usuariosFormatoArray as $usuario) {
			//$usuariosFormatoClase[] = new Usuario($usuario["Id"], $usuario["email"], $usuario["password"], $usuario["edad"], $usuario["pais"], $usuario["username"]);
	...
	function traerPorMail($email) {
		...
		if ($usuarioFormatoArray) {
			//$usuario = new Usuario($usuarioFormatoArray["Id"], $usuarioFormatoArray["email"], $usuarioFormatoArray["password"], $usuarioFormatoArray["edad"], $usuarioFormatoArray["pais"], $usuarioFormatoArray["username"]);
